...
*/
	...
	public static void main(String[] args) {
		...
		ConfigurableApplicationContext context = SpringApplication.run(BusGraphApplication.class, args);
		TuniseWebService tuniseWebService = context.getBean(TuniseWebService.class);
		String url = "http://localhost:8085/";
		Endpoint.publish(url, tuniseWebService);
		System.out.println("url : http://localhost, " + "listening on port 8085");
